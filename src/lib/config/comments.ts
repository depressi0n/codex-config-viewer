...
function resolveTopLevelFieldKey(key: string) {
  const topLevelFields: Record<string, string> = {
    ...
    model_supports_reasoning_summaries: "modelSupportsReasoningSummaries",
    model_catalog_json: "modelCatalogJson",
    model_instructions_file: "modelInstructionsFile",
    ...
    mcp_oauth_callback_port: "mcpOauthCallbackPort",
    ...
    notify: "notify",
    experimental_compact_prompt_file: "experimentalCompactPromptFile",
    background_terminal_max_timeout: "backgroundTerminalMaxTimeout",
    log_dir: "logDir",
    ...
    windows_wsl_setup_acknowledged: "windowsWslSetupAcknowledged",
...
function resolveNestedFieldKey(root: string, key: string) {
  const nestedFields: Record<string, Record<string, string>> = {
    ...
    features: {
      ...
      personality: "personalityFeature",
      fast_mode: "fastMode",
    ...
    shell_environment_policy: {
      ...
      experimental_use_profile: "experimentalUseProfile",
    },
    tools: {
    ...
    agents: {
      ...
      interrupt_message: "agentsInterruptMessage",
    },
    model_providers: {
      name: "providerName",
      base_url: "baseUrl",
      ...
      args: "authArgs",
      cwd: "authCwd",
      timeout_ms: "authTimeoutMs",
      refresh_interval_ms: "authRefreshIntervalMs",
      profile: "awsProfile",
      region: "awsRegion",
    },
    mcp_servers: {
